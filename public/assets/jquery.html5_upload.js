...
﻿  ﻿  ﻿  ﻿  if (!$this.triggerHandler('html5_upload.onStartOne', [(file.name || file.fileName), number, total])) {
﻿  ﻿  ﻿  ﻿  ﻿  return upload_file(number+1);
﻿  ﻿  ﻿  ﻿  }
﻿  ﻿  ﻿  ﻿  options.setStatus(options.genStatus(0));
﻿  ﻿  ﻿  ﻿  options.setName(options.genName((file.name || file.fileName), number, total));
﻿  ﻿  ﻿  ﻿  options.setProgress(options.genProgress(0, file.fileSize));
﻿  ﻿  ﻿  ﻿  xhr.upload['onprogress'] = function(rpe) {
﻿  ﻿  ﻿  ﻿  ﻿  $this.trigger('html5_upload.onProgress', [rpe.loaded / rpe.total, (file.name || file.fileName), number, total]);
﻿  ﻿  ﻿  ﻿  ﻿  options.setStatus(options.genStatus(rpe.loaded / rpe.total));
﻿  ﻿  ﻿  ﻿  ﻿  options.setProgress(options.genProgress(rpe.loaded, rpe.total));
﻿  ﻿  ﻿  ﻿  };
﻿  ﻿  ﻿  ﻿  xhr.onload = function(load) {
﻿  ﻿  ﻿  ﻿  ﻿  $this.trigger('html5_upload.onFinishOne', [xhr.responseText, (file.name || file.fileName), number, total]);
﻿  ﻿  ﻿  ﻿  ﻿  options.setStatus(options.genStatus(1, true));
...
﻿  ﻿  ﻿  ﻿  ﻿  $this.trigger('html5_upload.onError', [(file.name || file.fileName), e]);
...
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  fileName = unescape(encodeURIComponent((file.name || file.fileName))); //encode_utf8
